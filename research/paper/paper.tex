...
\begin{table}[t]
\caption{Data of the rigorous computer-assisted proofs of Theorem~\ref{thm:finite}. Draft: the branch-and-bound runs for $\nu=7,8$ are still in progress; an earlier run with safety margins instead of interval arithmetic succeeded with 323 and 385 boxes.}
...
7 & $i$ & $[2.23344617477,\,2.23344617480]$ & 5.3445 & 0.0050 & \emph{running}\\
8 & $i$ & $[1.55240121256,\,1.55240121259]$ & 5.8308 & 0.0026 & \emph{running}\\\bottomrule
\end{tabular}
\end{table}

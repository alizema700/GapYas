...
\begin{table}[t]
\caption{Data of the rigorous computer-assisted proofs of Theorem~\ref{thm:finite}. Draft: the branch-and-bound run for $\nu=7$ is still in progress; an earlier run with safety margins instead of interval arithmetic succeeded with 323 boxes.}

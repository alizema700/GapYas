...
**Pilotergebnisse [Pilot, ungeprüft]** (`opt_test.py`, `opt2.py`, `opt3.py`; GZL `zeta_circle`, Einheitsvolumen, gleiche ν auf allen drei Kanten; [gzl auf PyPI](https://pypi.org/project/gzl/)):

In 2D ist das Hexagonalgitter für ν ≲ 3,918 global optimal, darüber das Quadratgitter.
...
4. Die Pilotzahlen sind nicht begutachtet.
...
**Pilotergebnisse [Pilot, ungeprüft]** (`mgf_test.py`, `mgf_test2.py`):
...
- Ein neuer Satz über modulare Funktionen: Mit dem Wörterbuch aus Idee 1 wandert **das Minimum von C_{s,s,s}(τ) über der Fundamentaldomäne bei s\* ≈ 1,959 vom hexagonalen zum quadratischen Punkt** [Pilot]. Nach den Notizen hat diese Frage noch niemand gestellt.
